...
Bootstraping new validator set for based rollups presents a significant challenge. The process of bootstrapping a new network of validators is time-consuming and resource-intensive. This "cold start" problem can be a major hurdle for new based rollups, slowing down their launch.
</Accordion>
