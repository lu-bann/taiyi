...
| Delegation | Validators can delegate preconfirmation duties to preconf operators | Preconf operators handle preconfirmation tasks on behalf of validators |
...
graph TD
    ...
    PRECONFSERVICEOPERATOR -->|opts in| PRECONFIRMERSERVICEMANAGER
