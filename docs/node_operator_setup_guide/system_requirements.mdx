...
description: 'Before setting up your Taiyi node on testnet, ensure your system meets the following requirements for hardware, software, and initial configuration.'
icon: 'list-check'
---
...
*Note: These components are already deployed on Testnet and managed by the Luban team*
...
### On-chain Components
<Note>
As of 2025-01-01,Testnet ETH is required to participate in the testnet. The protocol is in testing phase and only requires registration by calling the necessary smart contract functions. 
