...
<Note>
Storage requirements will grow over time. Ensure you have room for chain data expansion and transaction history.
</Note>
...
**<u>Required Components (Setup by Operator)</u>**
- **Commit-boost**: Local builder service that handles block building and validation, integrating with the Taiyi network for preconfirmations.
  [Source](https://github.com/Commit-Boost/commit-boost-client)

- **Taiyi-boost**: Core component that manages preconfirmation services and interfaces with the Helix relay network.
  [Source](https://github.com/lu-bann/taiyi/tree/dev/bin/taiyi-boost)
