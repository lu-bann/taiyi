...
impl<T, P> LubanRpcImpl<T, P>
where
    T: Transport + Clone,
    P: Provider<T, Ethereum>,
{
    pub async fn new(chain_id: U256, validator: Validator<T, P>, commit_boost_url: String) -> Self {
...
#[async_trait]
impl<T, P> LubanRpcServer for LubanRpcImpl<T, P>
where
    T: Transport + Clone,
...
pub async fn start_rpc_server(
    ...
    let provider = ProviderBuilder::new()
        ...
        .on_builtin(&rpc_url)
        .await?;
    let validator = Validator::new(provider, luban_escrow_contract_addr, luban_service_url);
    let rpc = LubanRpcImpl::new(U256::from(1337), validator, commit_boost_url).await;
