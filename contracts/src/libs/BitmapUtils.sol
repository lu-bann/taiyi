 ...
 * @dev Adapted from https://github.com/Layr-Labs/eigenlayer-middleware/blob/dev/src/libraries/BitmapUtils.sol
 */
library BitmapUtils {
        ...
        returns (uint256)
    {
        ...
        require(
            orderedBytesArray.length <= MAX_BYTE_ARRAY_LENGTH, BytesArrayLengthTooLong()
        );
